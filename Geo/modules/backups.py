...
import Geo.modules.sql.notes_sql as sql
from Geo import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from Geo.__main__ import DATA_IMPORT
from Geo.modules.helper_funcs.chat_status import user_admin
from Geo.modules.helper_funcs.alternate import typing_action

# from Geo.modules.rules import get_rules
import Geo.modules.sql.rules_sql as rulessql

# from Geo.modules.sql import warns_sql as warnssql
import Geo.modules.sql.blacklist_sql as blacklistsql
from Geo.modules.sql import disable_sql as disabledsql

# from Geo.modules.sql import cust_filters_sql as filtersql
# import Geo.modules.sql.welcome_sql as welcsql
import Geo.modules.sql.locks_sql as locksql
from Geo.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("Geo{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Geo{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Geo-Backup` was specially made for notes.".format(
            chat.title,
            chat_id,
            tgl,
        ),
    ...
    os.remove("Geo{}.backup".format(chat_id))  # Cleaning file
