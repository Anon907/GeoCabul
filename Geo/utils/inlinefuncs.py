...
from Geo import pbot as app 
from Geo import arq
from Geo.services.keyboard import Ikb
from Geo.utils.pluginhelper import convert_seconds_to_minutes as time_convert, fetch
from Geo.services.tasks import _get_tasks_text, all_tasks, rm_task
from Geo.services.types import InlineQueryResultCachedDocument
from Geo.modules.info import get_chat_info, get_user_info
from Geo.modules.music import download_youtube_audio
from Geo.utils.functions import test_speedtest
from Geo.utils.pastebin import paste
...
async def inline_help_func(__HELP__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph//file/cabb065eb5c2d1c76f3eb.jpg",
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url="https://t.me/geocabulbot"),
        InlineKeyboardButton(
    ...
    msg = f"""
**[GEO CABUL ❤️](https://t.me/nightlifelovers):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [UBOT](t.me/OmGeorgeMu)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
...
async def music_inline_func(answers, query):
    chat_id = -1001431625020
    group_invite = "https://t.me/joinchat/+9_HCqcl_aMo2NTA1"
    try:
        messages = [
            m
