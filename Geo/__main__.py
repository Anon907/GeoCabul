...
import sys
import traceback
import Geo.modules.sql.users_sql as sql
...
from Geo.modules import ALL_MODULES
from Geo.modules.helper_funcs.chat_status import is_user_admin
from Geo.modules.helper_funcs.misc import paginate_modules
...
PM_START_TEXT = """
*Hello {} !*
✪ I'm GEO CABUL Management Bot [✨](https://telegra.ph//file/cabb065eb5c2d1c76f3eb.jpg)
────────────────────────
× *Uptime:* `{}`
× `{}` *users, across* `{}` *chats.*
────────────────────────
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Geo.modules." + module_name)
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 ...
                 [
                    InlineKeyboardButton(text="Source Code", url="https://github.com/kennedy-ex/Geo"),
                 ],
                 [
